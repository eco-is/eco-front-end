...
@Component({
  ...
  templateUrl: './browse-lectures.component.html',
  styleUrls: ['./browse-lectures.component.scss'],
})
export class BrowseLecturesComponent implements OnInit {
  user: User | undefined;
  lectures: Lecture[] = [];
  ...
  ngOnInit(): void {
    ...
    this.service.getAllLectures().subscribe({
      next: (result: Lecture[]) => {
